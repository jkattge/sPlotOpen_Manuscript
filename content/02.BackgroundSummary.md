...
As many as 1 million species are estimated to be already facing extinction, the far majority due to anthropogenic impacts, land-use and climate change (@ipbes2019, @isbn:9782940529902). 
...
Large collections of plant occurrence data do exist at the global extent via the Global Biodiversity Information Facility (GBIF) (https://www.gbif.org/). 
However, these presence-only data neglect how individual plant species co-occur and interact locally to form plant communities.  
